...
const MODULES = [
  {
    ...
    cards: [
      ...
      { question: "Первый признак равенства треугольников (по двум сторонам и углу)", answerType: "text", answer: "Если две стороны и угол между ними одного треугольника соответственно равны двум сторонам и углу между ними другого треугольника, то такие треугольники равны." },
      { question: "Второй признак равенства треугольников (по стороне и двум углам)", answerType: "text", answer: "Если сторона и два прилежащих угла одного треугольника соответственно равны стороне и двум прилежащим углам другого треугольника, то такие треугольники равны." },
      { question: "Третий признак равенства треугольников (по трём сторонам)", answerType: "text", answer: "Если три стороны одного треугольника соответственно равны трём сторонам другого треугольника, то такие треугольники равны." },
      ...
      { question: "Обратная обобщённая теорема Фалеса", answerType: "text", answer: "Если прямые, пересекающие две другие прямые, отсекают на обеих из них пропорциональные отрезки (начиная от вершины), то такие прямые параллельны." },
      ...
      { question: "Теорема Пифагора (прямая и обратная)", answerType: "text", answer: "Прямая: c² = a² + b² (квадрат гипотенузы = сумма квадратов катетов). Обратная: если квадрат стороны равен сумме квадратов двух других сторон, то треугольник прямоугольный." },
      ...
      { question: "Формула Брахмагупты (площадь вписанного четырёхугольника)", answerType: "text", answer: "S = √((p−AB)(p−BC)(p−CD)(p−DA)), где p — полупериметр." },
      ...
      // --- 12. Крутые факты планиметрии ---
      { question: "Параллелограмм Вариньона", answerType: "text", answer: "Середины сторон любого выпуклого четырёхугольника являются вершинами параллелограмма." },
      { question: "Лемма о трезубце", answerType: "text", answer: "Биссектриса угла B пересекает описанную окружность в точке P. Тогда P равноудалена от A, C, I (инцентр) и I_B (центр вневписанной окружности, касающейся AC)." },
      { question: "Прямая Симсона", answerType: "text", answer: "Из точки P опущены перпендикуляры на прямые, содержащие стороны треугольника. Основания перпендикуляров лежат на одной прямой ⟺ P лежит на описанной окружности." },
    ],
  },
];
